...
function AnimationBox({ onClickRefresh, refresh }: AnimationBoxProps) {
  return (
    <ContentContainer bgColor="rgb(255,255,255),rgb(190,90,20)">
      ...
      <Box
        ...
        key={refresh[0]}
      />
      <RefreshBtn onClick={() => onClickRefresh(0)}>
        <svg
          width={"100%"}
          height={"100%"}
